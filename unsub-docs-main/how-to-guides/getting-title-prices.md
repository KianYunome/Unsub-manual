---
description: All about finding title prices(タイトル価格の見つけ方のすべて)
---

# Getting Title Prices(タイトル価格の入手)

[A title price is required for a journal to appear in your Unsub dashboard:Unsubダッシュボードにジャーナルを表示するには、タイトル価格が必要になります。](../troubleshooting/why-dont-i-see-a-certain-title-in-my-dashboard.md).&#x20;
